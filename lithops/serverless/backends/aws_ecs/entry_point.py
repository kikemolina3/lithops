...
if __name__ == '__main__':
    ...
    os.environ['__LITHOPS_BACKEND'] = 'AWS ECS (Fargate)'
    ...
    if action == 'get_metadata':
        ...
        lithops_config_json = os.environ['__LITHOPS_CONFIG']
        lithops_config = json.loads(lithops_config_json)
        ...
        def get_job_index(config, payload):
            ...
            task_metadata_url = f"{metadata_url}/task"
